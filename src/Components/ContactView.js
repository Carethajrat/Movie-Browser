...
import BackroundImageContact from "../contact-bg.jpg";
    ...
    emailjs
      ...
      .then(
        (result) => {
          ...
          alert("The Message successfully !");
        },
        (error) => {
  ...
  return (
    <>
      ...
      <div
        ...
        style={{
          backgroundImage: `url(${BackroundImageContact})`,
          ...
          <div className="container">
            <div className="row row-cols-1">
              <form
                ...
                ref={form}
                onSubmit={sendEmail}
                className="col-lg-6 col-md-6 col-sm-4 shadow-lg"
              >
